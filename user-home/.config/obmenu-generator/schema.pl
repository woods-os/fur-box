...
#
#      # Configuration files
#      {item => ["gedit ~/.conkyrc",              'Conky RC',    'text-x-generic']},
#      {item => ["gedit ~/.config/tint2/tint2rc", 'Tint2 Panel', 'text-x-generic']},
#
#      # obmenu-generator category
#      {begin_cat => ['Obmenu-Generator', 'accessories-text-editor']},
#        {item      => ["gedit ~/.config/obmenu-generator/schema.pl", 'Menu Schema', 'text-x-generic']},
#        {item      => ["gedit ~/.config/obmenu-generator/config.pl", 'Menu Config', 'text-x-generic']},
#
#        {sep  => undef},
...
#        {item      => ["gedit ~/.config/openbox/autostart", 'Openbox Autostart',   'text-x-generic']},
#        {item      => ["gedit ~/.config/openbox/rc.xml",    'Openbox RC',          'text-x-generic']},
#        {item      => ["gedit ~/.config/openbox/menu.xml",  'Openbox Menu',        'text-x-generic']},
